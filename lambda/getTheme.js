...
/******/ 	return __webpack_require__(__webpack_require__.s = "./getTheme.js");
/******/ })
/************************************************************************/
/******/ ({
...
exports.handler = (event, context, callback) => {
  ...
  return client.query(q.Paginate(q.Match(q.Index("all_movies")))).then(response => {
    ...
    return client.query(getAllMoviesQuery).then(allMoviesResponse => {
