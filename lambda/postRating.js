...
/******/ 	return __webpack_require__(__webpack_require__.s = "./postRating.ts");
/******/ })
/************************************************************************/
/******/ ({
...
exports.handler = async event => {
  ...
  try {
    const response = await _lambda__WEBPACK_IMPORTED_MODULE_0__["client"].query(_lambda__WEBPACK_IMPORTED_MODULE_0__["faunaDbQuery"].Update(_lambda__WEBPACK_IMPORTED_MODULE_0__["faunaDbQuery"].Ref(_lambda__WEBPACK_IMPORTED_MODULE_0__["faunaDbQuery"].Collection("movies"), currentMovie.id), rating));
    return {
      statusCode: 200,
